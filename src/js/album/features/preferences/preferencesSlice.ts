...
import { DefaultPreferences, Preferences } from '../../../lib/background/preferences';
...
export const selectTweetPreferences = (state: RootState) => state.preferences.preferences.tweet;
